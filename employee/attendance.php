...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($attendance) {
        ...
        if ($check_out) {
            ...
            $updateStmt->execute(['employee_id' => $employeeID, 'date' => $date]);
        ...
        if ($check_in) {
            ...
            $insertStmt->execute(['employee_id' => $employeeID, 'date' => $date]);
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <select name="employee_id" id="employee_id" class="form-control">
                                ...
                                <?php if ($employee) { ?>
                                    <option value="<?php echo $employee['EmployeeID']; ?>" selected>
